...
const trendingItems = [
  { src: "/assets/images/wedding ring 1.png", title: "Wedding Rings" },
  { src: "/assets/images/couple ring.png", title: "Couple Ring" },
  { src: "/assets/images/shine like a night.png", title: "Shine Like A Night" },
  { src: "/assets/images/Rose Gold Radiance.png", title: "Rose Gold Radiance" },
  { src: "/assets/images/Golden Glow.png", title: "Golden Glow" },
  { src: "/assets/images/Whisper Winter.png", title: "Whisper Winter" },
];
    ...
    <div className="w-full mt-32">
      ...
      <div className="w-full h-[600px] grid grid-cols-3 items-center justify-items-center gap-8">
        {trendingItems.map((item, index) => (
          <div
            key={index}
            className="w-[426px] h-[160px] rounded-[7px] relative"
          >
